...
public class DetailAdat extends AppCompatActivity {
    ...
    //database textview
    TextView tvntoko, tvjm, tvalmt, tvnamabaju, tvknds, tvharga, tvketerangan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvalmt  = (TextView) findViewById(R.id.tvalmta);
        ...
        tvntoko.setText(mIntent.getStringExtra("Nmtk"));
        tvjm.setText(mIntent.getStringExtra("Jm"));
        tvalmt.setText(mIntent.getStringExtra("Almt"));
